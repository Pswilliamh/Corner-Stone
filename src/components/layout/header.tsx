...
import { Gem, BookOpenText, Search, Lightbulb, Users, ScrollText, Home } from 'lucide-react'; // Added Home
...
const Header = () => {
  ...
  const navItems = [
    { href: '/', label: 'Identify Rock', icon: Gem },
    ...
    <header className="bg-card border-b border-border shadow-md sticky top-0 z-50">
      <div className="container mx-auto px-4 h-20 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-3 text-2xl font-bold text-primary hover:text-primary/90 transition-colors">
          <Image src={koheLogoUrl} alt="Kingdom Of Heaven Embassy Inc. Logo" width={50} height={50} className="rounded-sm" data-ai-hint="logo religious" />
