...
import { Gem, BookOpenText, Search, Lightbulb, Users, Home } from 'lucide-react';
...
const Header = () => {
  ...
  const navItems = [
    ...
    { href: '/#identify-rock-section', label: 'Identify Rock', icon: Gem }, // Changed to anchor link
          ...
          {navItems.map((item) => (
            <Button
              ...
              className={cn(
                ...
                // For anchor links on the same page, pathname might not match exactly.
                // This logic might need refinement if active state for anchor links is crucial.
