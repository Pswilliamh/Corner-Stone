...
import { HomeIcon, Gem, BookOpenText, Lightbulb, UserCircle, Sprout, ShoppingCart } from 'lucide-react'; // Added Lightbulb and ShoppingCart
...
const Header = () => {
  ...
  const navItems = [
    ...
    { href: '/lifecycle-system', label: 'K.O.H.E. System', icon: ShoppingCart }, // New Item
